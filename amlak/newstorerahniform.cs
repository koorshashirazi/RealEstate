...
namespace amlak
{
    public partial class newstorerahniform : Form
    {
        ...
        public newstorerahniform(int status)
        {
            InitializeComponent();
              statusForm = status;
            if (statusForm == 1)
        ...
        private void newstorerahniform_Load(object sender, EventArgs e)
        {
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from rahnimaghaze";

            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into rahnimaghaze(id,adress,gheymat,namekharidar,namesaheb,tarikh)values(@i,@a,@b,@c,@d,@e)";
        ...
        private void newstorerahniform_Load_1(object sender, EventArgs e)
        {
