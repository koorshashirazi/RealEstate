...
namespace amlak
{
    public partial class newzaminforoshiform : Form
    {
        ...
        public newzaminforoshiform(int status)
        {
            InitializeComponent();
            statusForm = status;
            if (statusForm == 1)
        ...
        private void newzaminforoshiform_Load(object sender, EventArgs e)
        {
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from foroshizamin";

            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into foroshizamin(id,adress,gheymat,namekharidar,nameforoshande,tarikh)values(@i,@a,@b,@c,@d,@e)";
