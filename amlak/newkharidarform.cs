...
namespace amlak
{
    public partial class newkharidarform : Form
    {
        ...
        public newkharidarform(int status)
        {
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from kharidar";
            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into kharidar(id,name,family,shsh,nfather,tells,tellh,adressmanzel,adresswork)values(@i,@a,@b,@c,@d,@e,@f,@g,@h)";
        ...
        private void newkharidarform_Load(object sender, EventArgs e)
        {
