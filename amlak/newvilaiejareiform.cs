...
namespace amlak
{
    public partial class newvilaiejareiform : Form
    {
        ...
        public newvilaiejareiform(int status)
        {
            InitializeComponent();
            statusForm = status;
            if (statusForm == 1)
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from ejarevilla";

            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into ejarevilla(id,adress,keraye,gheymat,namekharidar,namesaheb,tarikh)values(@i,@a,@b,@c,@d,@e,@f)";
        ...
        private void newvilaiejareiform_Load(object sender, EventArgs e)
        {
