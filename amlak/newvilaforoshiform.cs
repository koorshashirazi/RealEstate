...
namespace amlak
{
    public partial class newvilaforoshiform : Form
    {
        ...
        public newvilaforoshiform(int status)
        {
            InitializeComponent();
             statusForm = status;
            if (statusForm == 1)
        ...
        private void newvilaforoshiform_Load(object sender, EventArgs e)
        {
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from foroshivilla";

            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into foroshivilla(id,adress,gheymat,namekharidar,nameforoshande,tarikh)values(@i,@a,@b,@c,@d,@e)";
