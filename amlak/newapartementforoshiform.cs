...
namespace amlak
{
    public partial class newapartementforoshiform : Form
    {
        ...
        public newapartementforoshiform(int status)
        {
            InitializeComponent();
            statusForm = status;
            if (statusForm == 1)
        ...
        private void newapartementforoshiform_Load(object sender, EventArgs e)
        {
        ...
        private void cmdok_Click(object sender, EventArgs e)
        {
            ...
            selectcom.CommandText = "select * from foroshaparteman";

            SqlCommand insertcom = con.CreateCommand();
            insertcom.CommandText = "insert into foroshaparteman(id,adress,gheymat,namekharidar,namesaheb,tarikh)values(@i,@a,@c,@d,@e,@f)";
